...
class TTexts {
  ...
  // -- Welcome Screen Text
  static const String welcomeTitle = "Find Your Buddies!";
  static const String welcomeSubTitle = "Let's find new buddies for life with us! Whole buddies are waiting for you!";
}
